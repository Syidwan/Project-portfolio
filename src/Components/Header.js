        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          ...
          <a href={instagram} target="_blank" rel="noreferrer noopener">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M15 0C6.715 0 0 6.715 0 15C0 23.285 6.715 30 15 30C23.285 30 30 23.285 30 15C30 6.715 23.285 0 15 0ZM22.5 8.75C23.19 8.75 23.75 9.31 23.75 10C23.75 10.69 23.19 11.25 22.5 11.25C21.81 11.25 21.25 10.69 21.25 10C21.25 9.31 21.81 8.75 22.5 8.75ZM15 10C17.761 10 20 12.239 20 15C20 17.761 17.761 20 15 20C12.239 20 10 17.761 10 15C10 12.239 12.239 10 15 10ZM15 8.75C11.5482 8.75 8.75 11.5482 8.75 15C8.75 18.4518 11.5482 21.25 15 21.25C18.4518 21.25 21.25 18.4518 21.25 15C21.25 11.5482 18.4518 8.75 15 8.75ZM15 2.5C22.4558 2.5 27.5 7.54417 27.5 15C27.5 22.4558 22.4558 27.5 15 27.5C7.54417 27.5 2.5 22.4558 2.5 15C2.5 7.54417 7.54417 2.5 15 2.5Z" />
            </svg>
          </a>
          <li>
